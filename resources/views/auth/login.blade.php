...
<html lang="en">
    ...
    <head>
        <title>@yield('title') | Hvl Management</title>
        <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="{{asset('vendor/profile/style.css')}}">
                        ...
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form  method="POST" action="{{ route('login') }}" class="signin-form">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" autocomplete="email" autofocus placeholder="Email ID/User ID" data-error=".errorTxt1">
