...
<div class="card">
    <div class="card-content">
        <h5 class="title-color"><span>Edit Leave Request -HR</span></h5>
        @foreach($leaverequest as $l)
        <form action="{{route('hrms.leaverequest.hr.approve.update',['id'=>$l->id])}}" method="post">
            @endforeach
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="input-field col s2">
                    ...
                    @foreach($leaverequest as $l)
                    <input type="text" placeholder="From Date" class="datepicker input-field" id="from_date" name="from_date" value="{{$l->from_date}}" disabled>
                    @endforeach
                </div>
                ...
                <div class="input-field col s2">
                    ...
                    @foreach($leaverequest as $l)
                    <input type="text" placeholder="End Date" class="datepicker input-field" id="end_date" name="end_date" value="{{$l->end_date}}" disabled>
                    @endforeach
                </div>
            ...
            <div class="row">
                ...
                <input type="hidden" name="reject_not_hr_date" id="reject_not_hr_date" value="<?php echo date("Y-d-m"); ?>"/>
                <div class="input-field col s4 rejectNot"  style="display: none;">
                    <label for="fn">Comment *</label>
                    <textarea name="reject_not_hr"
                              id="reject_not_hr"
                        ...
                        $(document).ready(function () {
                            ...
                            $('#status').on('change', function () {
                                ...
                                function dynamic_field(values) {
                                    html = '<label for="fn">Comment *</label><textarea name="reject_not_hr" id="reject_not_hr" placeholder="Enter Comment" class="materialize-textarea" required=""></textarea>';
