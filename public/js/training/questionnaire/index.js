$(document).ready(function () {
    ...
    $('#questionnaire_datatable').DataTable({
        "processing": true,
        "serverSide": false,

        "ajax": "/training/questionnaire/getdata",
        "columns": [
            {"data": "id"},
...
$(document).on('click', '.delete', function () {
    ...
    swal({
        ...
        if (willDelete) {
            $.ajax({
                url: "/training/questionnaire/removedata",
                mehtod: "get",
                data: {id: id},
                success: function (data)
                {
                    $('#questionnaire_datatable').DataTable().ajax.reload();
...
$(document).on('click', '#bulk_delete', function () {
    ...
    swal({
        ...
        if (willDelete) {
            ...
            {
                $.ajax({
                    url: "/training/questionnaire/massremove",
                    method: "get",
                    data: {id: id},
                    success: function (data)
                    {
