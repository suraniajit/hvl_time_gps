    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item ">Edit Customer Login </li>
            </ul>
        </div>
    </div>
    <section>
            ...
            <div class="card">
                <div class="card-body p-4">
                    <header>
                        <div class="row">
                            <div class="col-md-7">
                                <h2 class="h3 display"> Edit Customer Login</h2>
                                <p style="font-size: 12px;"><strong>Note:</strong>Password Optional if Enter Then Update.</p>
                            </div>
                        </div>

                    </header>
                    <form action="{{route('customer.login_system.update')}}" id="formValidate" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6 col-md-4">
                                ...
                                <input type="hidden" value="{{ $custeradmin->user_id }}"  name="user_id">
                                
                                <input type="text" value="{{ $custeradmin->name }}"  name="customer_admin_name" required class="form-control"  placeholder="Enter Customer Name" data-error=".errorTxt2" autocomplete="off" autofocus="off">
                            ...
                            <div class="form-group col-sm-6 col-md-4">
                                ...
                                <input type="email" name="email" value="{{ $custeradmin->email }}" class="form-control" required  placeholder="Enter Customer Admin Emain" data-error=".errorTxt3" autocomplete="off" autofocus="off">
                                <div class="errorTxt3 text-danger">{{ ($errors->has('email'))?$errors->first('email'):''}}</div>
                            </div>
                            <div class="form-group col-sm-6 col-md-4">
                                <label>Password</label>
                                <input type="text" name="password" class="form-control"  placeholder="Enter Customer Password " data-error=".errorTxt4" autocomplete="off" autofocus="off">
