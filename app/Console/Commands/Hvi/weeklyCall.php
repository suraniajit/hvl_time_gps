...
class WeeklyCall extends Command {
     ...
     * @var string
     */
    protected $signature = 'WeeklyCall:hiv';
     ...
     * @var string
     */
    protected $description = 'WeeklyCall: it is only insert fresh data into table for insert and update enty for every calcaution';
