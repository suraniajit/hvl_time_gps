                ...
                select: function(info) {
                    ...
                    $.getJSON("/hrms/leaverequest/create", function(result){
                        ...
                        $.each(result, function(i, field){
                            ...
                            $('#leaverequest_modal').find('#department_lead_id').val(field.data[0]['id']);
                            $('#leaverequest_modal').find('#is_confirm').val(field.emp[0]['employee_type_id']);
    ...
    function changedata(){
       ...
       $.getJSON("/attendance/pendingleave/"+id, function(result){
        ...
        $.getJSON("/attendance/getleavedata/"+id, function(result){
            $.each(result, function(i, field){
                $('[data-date='+field+']').css('background-color','#81C784');
