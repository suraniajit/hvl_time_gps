...
/*
        $('.srt',this).mousedown(function () {
            console.log('on');
            $(this).css('color','green');
            $('#ckk').sortable();
        });
        $('.srt',this).mouseup(function () {
            console.log('off');
            $(this).css('color','blue');
            $('#ckk').sortable('destroy');
        });*/
    }).
...
$(document).on('click', '.clickme', function () {
    ...
    $('.clickme').each(function () {
        ...
        index++;
        $(this,'.imgshow').parent().addClass("c"+index);
        ...
        function readURL(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    console.log('.imgshow c'+index);
                    $('.c'+index).css("background-image", "url('" + e.target.result + "')");
                    $('.c'+index).css("background-repeat", "no-repeat");
                    $('.c'+index).css("background-position", "center");
                    $('.c'+index).css("border", "");
                    $('#remove').remove();
                }
