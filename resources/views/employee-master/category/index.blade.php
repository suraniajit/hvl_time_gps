...
<section>
    <div class="container-fluid">
        ...
        <header>
            <div class="row">
                <div class="col-md-7">
                    <h2 class="h3 display">Category Master</h2>
                </div>
                <div class="col-md-5">
                    <a href="{{route('category.create')}}" class="btn btn-primary pull-right rounded-pill">Add Category</a>
                </div>
            </div>
        </header>
        <div class="table-responsive">
            <table id="page-length-option" class="table table-striped table-hover multiselect">
                ...
                <tbody>
                    @foreach($categoryDetails as $key => $Detailes)
                    <tr>
                        <td width="4%">
                            <label>
                        ...
                        <td width="8%">
                            <!--can('Edit category')-->
                            <a href="{{ route('category.edit', $Detailes->id) }}"
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result == 1) {
                                swal("Category is linked to subcategory and cannot be deleted", {
                                    icon: "error",
                                }).then(function () {
                                    location.reload();
                                });
