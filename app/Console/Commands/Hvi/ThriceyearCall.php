...
class ThriceyearCall extends Command {
     ...
     * @var string
     */
    protected $signature = 'ThriceyearCall:hiv';
     ...
     * @var string
     */
    protected $description = 'ThriceyearCall: it is only insert fresh data into table for insert and update enty for every calcaution';
