...
<div class="card">
    <div class="card-content">
        <h5 class="title-color"><span>Create Vehicle</span></h5>
        <form id="VehiclesMaster" action="{{route('vehicles.store')}}" method="post">
            {{csrf_field()}}
            <div class="row">
                <div class="input-field col s3">
                    <label>Vehicle User*</label>
                    <input type="text" name="name" placeholder="Enter Vehicle User" data-error=".errorTxt1" />
                    <div class="errorTxt1"></div>
                </div>
                <div class="input-field col s3">
                    <label>Rate per Km*</label>
                    <input type="number" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"  name="rate_per_km" placeholder="Enter Vehicle Rate per Km" data-error=".errorTxt2" />
                    <div class="errorTxt2"></div>
                </div>
                <div class="input-field col s3"> 
                    <label>Expiry Date of Vehicle Banding Permit</label>
                    <input type="text" class="date" name="expiry_date_permit" id="expiry_date_permit" placeholder="Select Expiry Date of Vehicle Banding Permit" >
                </div> 

                <div class="input-field col s3"> 
                    <label>Contract to Shift</label>
                    <input type="text" class="date" name="contract_to_shift" id="contract_to_shift" placeholder="Select Contract to Shift" >
                </div> 
            </div> 
            <div class="row">
                <div class="input-field col s3"> 
                    <label>Registration Date</label>
                    <input type="text" class="date" name="registration_date" id="registration_date" placeholder="Select Registration Date" >
                </div> 
                <div class="input-field col s3"> 
                    <label>Insurance Date</label>
                    <input type="text" class="date" name="insurance_date" id="insurance_date" placeholder="Select Insurance Date" >
                </div> 
                <div class="input-field col s3">
                    <label>Sticker Number </label>
                    <input type="number" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"  name="sticker_number" id="sticker_number" placeholder="Enter Sticker Number " />
                </div>
                <div class="input-field col s3"> 
                    <label>Next Service Date </label>
                    <input type="text" class="date" name="next_service_date" id="next_service_date" placeholder="Select Next Service Date" >
                </div> 
                <div class="input-field col s3"> 
                    <label>Handover Date </label>
                    <input type="text" class="date" name="handover_date" id="handover_date" placeholder="Select Handover Date" >
                </div> 
                <div class="input-field col s3"> 
                    <label>Surrender Date</label>
                    <input type="text" class="date" name="surrender_date" id="surrender_date" placeholder="Select Surrender Date">
                </div> 
            </div>
            <div class="row">
                <div class="input-field col s3">
                    <select name="is_active" data-error=".errorTxt3">
            ...
            <div class=" ">
                @include('employee-master.vehicles._dynamic')
            </div>
