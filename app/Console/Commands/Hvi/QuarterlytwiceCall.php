...
class QuarterlytwiceCall extends Command {
     ...
     * @var string
     */
    protected $signature = 'QuarterlytwiceCall:hiv';
     ...
     * @var string
     */
    protected $description = 'QuarterlytwiceCall: it is only insert fresh data into table for insert and update enty for every calcaution';
