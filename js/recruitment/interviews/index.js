$(document).ready(function() {
    ...
    $('#interviews_datatable').DataTable({
            ...
            "processing": true,
            "serverSide": false,
            "ajax": "/recruitment/interview/getdata",
            "columns": [
                {"data": "id"},
                {"data": "CandidateName"},
                {"data": "interview_name"},
...
$(document).on('click', '.delete', function() {
    ...
    swal({
        ...
        if (willDelete) {
            $.ajax({
                url: "/recruitment/interview/removedata",
                mehtod: "get",
                data: {id: id},
                success: function(data)
                {
                    $('#interviews_datatable').DataTable().ajax.reload();
...
$(document).on('click', '#bulk_delete', function() {
    ...
    swal({
        ...
        if (willDelete) {
            ...
            {
                $.ajax({
                    url: "/recruitment/interview/massremove",
                    method: "get",
                    data: {id: id},
                    success: function(data)
                    {
