<div class="modal fade bd-example-modal-xl relaince_service_report_model" tabindex="1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <img src="<?php echo e(asset('img/hvl-logo.png')); ?>" class="img-responsive" height="50" width="100" alt="">
            ...
            <div class="modal-body">
                <form id="relaince_service_form" name="relaince_service_form" enctype="multipart/form-data">
                    ...
                    <table border="1">
                        ...
                        <?php $__currentLoopData = $first_form_activity_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($key+1); ?></td>
                            <th>
                                <?php echo e($row); ?>

                                <input type="hidden" data-id="activity" value="<?php echo e($row); ?>"  class="form-control activity_first_element first_element rel_form">
                            </th>
                            <td> 
                    ...
                    <table border="1">
                        ...
                        <?php $__currentLoopData = $relaince_form_activity_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e(chr(97+$key)); ?></td>
                            <th>
                                <?php echo e($row); ?>

                                <input type="hidden" data-id="detail_of_activity" value="<?php echo e($row); ?>"  class="form-control rel_form detail_of_activity_second_element second_element">
                            </th>
                            <td> 
                    ...
                    <table border="1">
                        ...
                        <?php $__currentLoopData = $pest_controller_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pest_service_key=>$services): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e(chr($pest_service_key)); ?></td>
                            <td>
                                <?php echo e($services); ?>

                                <input type="hidden" data-id="pest_control_service" class="pest_control_service_fourth_element fourth_element rel_form" value="<?php echo e($services); ?>">
                            </td>
                            <td>
                                <select data-id="frequency" class="form-control frequency_fourth_element fourth_element rel_form">
                                <option value=""></option>
                                <?php $__currentLoopData = $frequency_option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td>
                                <img src="" class="pco_sign_image_fourth_element image_display" id="image_pco_<?php echo e($pest_service_key); ?>"  style="display:none" width="100">
                                <input type="hidden"   id="image_file_pco_<?php echo e($pest_service_key); ?>" data-id="pco_sign"  class="pco_sign_fourth_element rel_form fourth_element" value="">
                                <a href='javascript:;' id="pco_<?php echo e($pest_service_key); ?>" class="pco_sign_image_button siganature_click_button" data-toggle="modal" data-target="#SignatureModal"> Take New Signature</a>                           
                            </td>
                            <td>
                    ...
                    <table border="1">
                        ...
                        <?php $__currentLoopData = $month_week_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$week_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                            ...
                            <th>
                                ...
                                <input type="hidden" data-id="week"  value="<?php echo e($week_row); ?>" class="form-control week_fifth_element fifth_element rel_form">
                            </th>
                            <td>
                                <img src="" style="display:none" id="image_vender_<?php echo e($key); ?>" class="vender_sign_image_fifth_element image_display" width="100">
                                <input type="hidden" id="image_file_vender_<?php echo e($key); ?>" data-id="vender_sign" class="vender_sign_fifth_element rel_form fifth_element" value="">
                                <a href='javascript:;' id="vender_<?php echo e($key); ?>" class="vender_sign_image_button siganature_click_button" data-toggle="modal" data-target="#SignatureModal"> Take New Signature</a>
                            </td>
                            
                            <td>
                                <input type="text" data-id="store_manager_name" class="form-control rel_form store_manager_name_fifth_element fifth_element">
                            </td>
                            <th><?php echo e($week_row); ?></th>
                            <td>
                                <img src=""  style="display:none" id="image_store_manager_<?php echo e($key); ?>" class="store_manager_sign_image_fifth_element image_display"  width="100">
                                <input type="hidden" id="image_file_store_manager_<?php echo e($key); ?>" data-id="store_manager_sign" class="store_manager_sign_fifth_element rel_form fifth_element" value="">
                                <a href='javascript:;' id="store_manager_<?php echo e($key); ?>" class="store_manager_sign_image_button  siganature_click_button" data-toggle="modal" data-target="#SignatureModal"> Take New Signature</a>
                           </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </table>
...
<input type="hidden"  id="relaince_form_signature_element" value="">
                                <?php /**PATH C:\xampp_7.4.19\htdocs\web_project\HVL_Mar2024\resources\views/hvl/activitymaster/relaince_service_report_model.blade.php ENDPATH**/ ?>