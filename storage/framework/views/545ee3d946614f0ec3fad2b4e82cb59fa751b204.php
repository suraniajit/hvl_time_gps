...
<script>
    ...
    $('#mass_delete_id').click(function () {
        ...
        if (typeof checkbox_array !== 'undefined' && checkbox_array.length > 0) {
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(route('activity.massdelete')); ?>",
                        type: 'POST',
                        data: {
                            "_token": token,
                            ids: checkbox_array,
    ...
    $(document).on('click', '.button', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?php echo e(route('activity.hvi_hisrty_delete')); ?>",
                    type: "get",
                    data: {
                        "id": id
                    },
...
</script><?php /**PATH C:\xampp_7.4.19\htdocs\web_project\HVL_Mar2024\resources\views/hvl/activitymaster/_footer_script.blade.php ENDPATH**/ ?>