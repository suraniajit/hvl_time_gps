...
{{--    <select name="employees[]" class="select2 browser-default" multiple="multiple">--}}
{{--        <optgroup label="">--}}
...
@foreach(json_decode($forms->form) as $form)
        ...
        <div class="form-group col-sm-12 col-md-4">
            ...
            <input type="number"
                   ...
                   @if($form->required === true) required @endif
                   @if(str_replace(' ', '_', $form->label) == 'Quantity') readonly @endif
            @if(isset($form->placeholder)) placeholder="{{ $form->placeholder }}" @endif
...
//            @endforeach
        ...
        <div class="form-group col-sm-12 col-md-4">
            ...
            <select name="{{ str_replace(' ', '_', $form->label) }}[]" class="selectpicker form-control" multiple="multiple">
                <optgroup label="{{$form->label}}">
        ...
        <div class="form-group col-sm-12 col-md-4">
            ...
            <div class="file-path-wrapper">
                <input class="form-control-file validate" type="text">
            </div>
            @if(isset($table_data))
