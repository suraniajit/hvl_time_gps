                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create City')): ?>
                            <a href="<?php echo e(route('city.create')); ?>" class="btn btn-primary pull-right rounded-pill">Add City</a>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete City' )): ?>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="page-length-option" class="table table-striped table-hover multiselect">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $CityDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Detailes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                    <td width="8%">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit City')): ?>
                                        <a href="<?php echo e(route('city.edit', $Detailes->id)); ?>"
                                        ...
                                        <a href="#"
                                           ...
                                           data-position="top"
                                           data-tooltip="Delete" data-id="<?php echo e($Detailes->id); ?>">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <td width="2%"> <center><?php echo e($key+1); ?></center> </td>

                                    <td><?php echo e($Detailes->state_name); ?></td>
                                    <td><?php echo e($Detailes->city_name); ?></td>
                                    <td>
                ...
                if (typeof checkbox_array !== 'undefined' && checkbox_array.length > 0) {
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                $.ajax({
                                    url: '<?php echo e(route('city.multidelete')); ?>',
                                    type: 'get',
                                    data: {
                                        "_token": token,
                                        ids: checkbox_array,
...
<?php echo $__env->make('app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_7.4.19\htdocs\web_project\HVL_Mar2024\resources\views/hrms/city/index.blade.php ENDPATH**/ ?>