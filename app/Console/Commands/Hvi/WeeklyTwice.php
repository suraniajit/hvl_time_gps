...
class WeeklyTwice extends Command {
     ...
     * @var string
     */
    protected $signature = 'WeeklyTwice:hiv';
     ...
     * @var string
     */
    protected $description = 'WeeklyTwice: it is only insert fresh data into table for insert and update enty for every calcaution';
    ...
    public function handle() {
        ...
        foreach ($customer_activitys as $key => $activity) {
            ...
            $nextDate = date('Y-m-d', strtotime($start_date . " +3 days"));
