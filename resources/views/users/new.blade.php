            ...
            <div class="card">
                <div class="card-body p-4">
                    <header>
                        <div class="row">
                            <div class="col-md-7">
                                <h2 class="h3 display"> Add User</h2>
                            </div>
                        </div>

                    </header>

            <form id="create_user" action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-md-4">
                        ...
                        <input id="first_name" name="name"  type="text" class="validate form-control" @if(isset($user)) value="{{ $user->name }}" @endif required>
                    </div>
                    <div class="form-group col-sm-6 col-md-4">
                    ...
                    <div class="form-group col-sm-6 col-md-4">
                        ...
                        <input id="password" type="password" name="password" class="validate form-control" minlength="8" required="" data-error=".errorTxt1" value="Password@1234">
                        <div class="errorTxt1"></div>
                    </div>
                    <div class="form-group col-sm-6 col-md-4">
                        <label>Roles <span class="text-danger">*</span></label>
                        <select class="select" multiple="multiple" name="roles[]" required>
