...
class QuarterlyCall extends Command {
     ...
     * @var string
     */
    protected $signature = 'QuarterlyCall:hiv';
     ...
     * @var string
     */
    protected $description = 'QuarterlyCall: it is only insert fresh data into table for insert and update enty for every calcaution';
