...
//        $array = array('pageConfigs' => $pageConfigs,
//            'breadcrumbs' => $breadcrumbs,
//            'rightlink' => $rightlink);
//
//        return view('module.index', compact('columns', 'table', 'rows', 'filter_columns', 'save_filters', 'pageConfigs', 'breadcrumbs', 'rightlink'));
//
...
//
//
        //        $tname = ucfirst(str_replace('_', '%20', $module_name)) . " Master";
