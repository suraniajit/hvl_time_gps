...
//                                ->where('is_save', '=', 1)
                        ...
                        //app('App\Http\Controllers\Controller')->get_sum_of_data('api_expenses', 'is_user', $emp_id, 'total_amount_cash'); 
                        ?>
                    </h4>
                </div>
...
//                                ->whereIn('is_process', [0, 3])
                        ...
                        //app('App\Http\Controllers\Controller')->get_sum_of_data('api_expenses', 'is_user', $emp_id, 'settlement_amount'); 
                        ?>
                    </h4>
                </div>
                <div class="card-action green">
...
//echo 'INR ' . app('App\Http\Controllers\Controller')->get_sum_of_data('api_expenses', 'is_user', $emp_id, 'reject_amount'); 
                        ?>
                    </h4>
                </div>
                <div class="card-action red">
