...
class FortnightlyCall extends Command {
     ...
     * @var string
     */
    protected $signature = 'FortnightlyCall:hiv';
     ...
     * @var string
     */
    protected $description = 'FortnightlyCall: it is only insert fresh data into table for insert and update enty for every calcaution';
    ...
    public function handle() {
        ...
        foreach ($customer_activitys as $key => $activity) {
            ...
            $nextDate = date('Y-m-d', strtotime($start_date . " +15 days"));
