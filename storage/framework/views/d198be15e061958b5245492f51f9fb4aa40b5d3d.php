...
<div id="email_div" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body p-4 row">
                    <div class="col-sm-12">
                        <form action="<?php echo e(route('customer.mail_sheet')); ?>" method="post" id="mail_form" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
    ...
    </div><?php /**PATH C:\xampp_7.4.19\htdocs\web_project\HVL_Mar2024\resources\views/hvl/customermaster/_popup.blade.php ENDPATH**/ ?>