...
class OnetimeCall extends Command {
     ...
     * @var string
     */
    protected $signature = 'OnetimeCall:hiv';
     ...
     * @var string
     */
    protected $description = 'OnetimeCall: it is only insert fresh data into table for insert and update enty for every calcaution';
