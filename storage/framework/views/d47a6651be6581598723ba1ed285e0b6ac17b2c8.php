...
<head>
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="<?php echo e(asset('css/style.red.css')); ?>" id="theme-stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/datestyle.css')); ?>">
    <style>
        #load {
            width: 100%;
            height: 100%;
...
<div id="contents">
    ...
    <div class="page">
    <?php echo $__env->make('panels.header-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('js/custom/clock.js')); ?>"></script>
<script>
        let hour = 00; 
        let minute = 00; 
        let second = 00; 
...
<?php /**PATH C:\xampp_7.4.19\htdocs\web_project\HVL_Mar2024\resources\views/app/layout.blade.php ENDPATH**/ ?>